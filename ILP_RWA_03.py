...
def ILP_RWA_03(graph:nx.Graph, R:dict[int,tuple[int,int]], W:set[int], timelimit=0, restart=False) -> tuple[bool,float,int,dict[int, tuple[tuple[int, int], set[tuple[int, int, int]], int]],int]:
    ...
    if restart:
        ...
        model = gp.Model("ILP_RWA_03",env=env)
