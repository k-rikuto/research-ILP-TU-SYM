...
def ILP_RCWA_02(graph:nx.Graph, R:dict[int,tuple[int,int]], W:set[int], C:set[int], timelimit=0, restart=False) -> tuple[bool,float,int,dict[int, tuple[tuple[int, int], set[tuple[int, int, int]], int]],int]:
    ...
    if restart:
        ...
        model.update()
        model.Params.LogFile = "Logs/RCWA_02.log"
